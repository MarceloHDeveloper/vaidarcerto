...
export const _notifications = [...Array(4)].map((_, index) => ({
  ...
  type: ['friend', 'friend', 'friend', 'friend'][index],
  category: ['Communication', 'Communication', 'Communication', 'Communication'][index],
  isUnRead: _mock.boolean(index),
  createdAt: _mock.time(index),
  title:
    (index === 0 && `<p><strong>Frutal</strong> Solicitou 38 novos epis</p>`) ||
    (index === 1 && `<p><strong>Lajinha</strong> Solicitou 21 novas contratações</p>`) ||
    (index === 2 && `<p><strong>Matipó</strong> Solicitou 2 demissões de funcionários </p>`) ||
    (index === 3 && `<p><strong>Lajinha</strong> Solicitou 3 novas contratações  </p>`) ||
    (index === 4 && `<p>Matipó </strong> Solicitou 5 uniformes  <strong>$200</strong></p>`),
}));
